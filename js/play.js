...
(function(exports) {
  ...
  var rowUi = function (aUi) {
      return function (xs) {
          return $foreign.mkUi(function __do() {
              var v = Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(function ($18) {
                  return Flare.setupFlare(aUi($18));
              })(xs)();
  ...
  var upperChar = function (label) {
      return function (mc) {
          var strUi = createUI($foreign.cUpperChar)(label)(Data_Maybe.maybe("")(Data_String.singleton)(mc));
          return Data_Functor.map(Flare.functorUI)(function ($19) {
              return Data_Array.head(Data_String.toCharArray($19));
          })(strUi);
      };
  };
  exports["rowUi"] = rowUi;
...
(function(exports) {
  ...
  var renderItem = function (v) {
      if (v instanceof Text_Smolder_Markup.Element) {
          ...
          var b = "<" + (v.value0 + (showAttrs(v.value2) + (function () {
      ...
      if (v instanceof Text_Smolder_Markup.Content) {
          return Control_Monad_State_Class.state(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (s) {
              return Data_Tuple.Tuple.create(v.value1)(s + $$escape(v.value0));
          });
      };
      ...
      throw new Error("Failed pattern match at Text.Smolder.Renderer.String line 38, column 1 - line 38, column 45: " + [ v.constructor.name ]);
  };
