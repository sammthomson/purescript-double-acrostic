...
(function(exports) {
  ...
  var showClueCharBoardIdx = new Data_Show.Show(function (v) {
      return Data_Show.show(showBoardIdx)(v.value1) + (" " + Data_Show.show(showClueIdx)(v.value0.value0));
  });
  var re = function (s) {
  ...
  var defaultPuzzle = {
      ...
      numCols: 15,
      quote: "The hardest years in life are those between ten and seventy.",
      clues: [ mkClue("seat _")("heater"), mkClue("happening")("event"), mkClue("space-saving dorm trick")("loft"), mkClue("\"_ Game\" (Sci-Fi)")("enders"), mkClue("Maslow stacks 'em")("needs"), mkClue("long, loose, religious garment")("habit"), mkClue("chip in")("ante"), mkClue("Kobe expenditure")("yen"), mkClue("\"Tout le mange\" is what I would call it if we opened one.")("eatery"), mkClue("nothing but net")("swish") ]
  };
...
(function(exports) {
  ...
  var shuffleVals = function (dictFoldable) {
      return function (dictUnfoldable) {
          return function (m) {
              var mapGen = Data_Traversable.traverse(Data_Map.traversableMap)(Test_QuickCheck_Gen.applicativeGen)(function ($85) {
                  return Data_Functor.map(Test_QuickCheck_Gen.functorGen)(Data_Array.toUnfoldable(dictUnfoldable))(Test_QuickCheck_Gen.shuffle(Data_Array.fromFoldable(dictFoldable)($85)));
              })(m);
              var genState = {
                  newSeed: Test_QuickCheck_LCG.mkSeed(31),
                  size: 1
              };
              return Test_QuickCheck_Gen.evalGen(mapGen)(genState);
          };
      };
  };
  ...
  var groupIdxsByChar = function (clues) {
      ...
      var idxd = Control_Bind.join(Control_Bind.bindArray)(indexClueChars(Data_Functor.map(Data_Functor.functorArray)(function ($86) {
          return Data_String.toCharArray(Data_String.toUpper($86));
      })(clues)));
      return shuffleVals(Data_List_Types.foldableList)(Data_List_Types.unfoldableList)(Data_Foldable.foldl(Data_Foldable.foldableArray)(step)(Data_Map.empty)(idxd));
  };
  var mkCharMap = function (p) {
      var step = function (v) {
          return function (v1) {
              ...
              if (v1 instanceof Acrostic_Edit.LetterCell) {
                  var $66 = Data_Map.lookup(Data_Ord.ordChar)(v1.value1)(v.value1);
                  if ($66 instanceof Data_Maybe.Just) {
                      var $67 = Data_List.uncons($66.value0);
                      if ($67 instanceof Data_Maybe.Just) {
                          return new Data_Tuple.Tuple(Data_Bimap.insert(Acrostic_Puzzle.ordBoardIdx)(Acrostic_Puzzle.ordClueCharIdx)(v1.value0)($67.value0.head)(v.value0), Data_Map.insert(Data_Ord.ordChar)(v1.value1)($67.value0.tail)(v.value1));
                      };
                      return v2(true);
                  };
                  return v2(true);
      ...
      var start = new Data_Tuple.Tuple(Data_Bimap.empty, groupIdxsByChar(Acrostic_Puzzle.answers(p)));
  ...
  var board = function (p) {
      var getCharFromClues = function (v) {
          ...
          throw new Error("Failed pattern match at Acrostic.Play line 144, column 3 - line 148, column 47: " + [ v.constructor.name ]);
      };
  ...
  exports["shuffleVals"] = shuffleVals;
  exports["groupIdxsByChar"] = groupIdxsByChar;
