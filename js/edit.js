...
(function(exports) {
  ...
  var Data_Monoid_Dual = PS["Data.Monoid.Dual"];
  var Data_Ring = PS["Data.Ring"];
  var Data_Semigroup_Commutative = PS["Data.Semigroup.Commutative"];
  var Data_Unit = PS["Data.Unit"];
  var Prelude = PS["Prelude"];        
...
(function(exports) {
  ...
  var set = function (dictOrd) {
      return function (k) {
          return function (v) {
              return function (v1) {
                  return Multiset((function () {
                      var $44 = v === 0;
                      if ($44) {
                          return Data_Map["delete"](dictOrd)(k)(v1);
                      };
                      return Data_Map.insert(dictOrd)(k)(v)(v1);
                  })());
              };
          };
      };
  };           
  var freq = function (dictOrd) {
      return function (k) {
          return function (v) {
              return Data_Maybe.fromMaybe(0)(Data_Map.lookup(dictOrd)(k)(v));
          };
      };
  };
  var insertN = function (dictOrd) {
      return function (n) {
          return function (k) {
              return function (m) {
                  return set(dictOrd)(k)(freq(dictOrd)(k)(m) + n | 0)(m);
              };
          };
      };
  };
  var insert = function (dictOrd) {
      return insertN(dictOrd)(1);
  };
  var entryList = function (v) {
      return Data_Map.toAscUnfoldable(Data_List_Lazy_Types.unfoldableList)(v);
  };
  var mapAppend = function (dictOrd) {
      return function (f) {
          return function (ma) {
              return function (mb) {
                  var go = function (acc) {
                      return function (v) {
                          return insertN(dictOrd)(v.value1)(v.value0)(acc);
                      };
                  };
                  return Data_Foldable.foldl(Data_List_Lazy_Types.foldableList)(go)(mb)(Data_Functor.map(Data_List_Lazy_Types.functorList)(f)(entryList(ma)));
              };
          };
      };
  };
  var semigroupMultiset = function (dictOrd) {
      return new Data_Semigroup.Semigroup(mapAppend(dictOrd)(Control_Category.id(Control_Category.categoryFn)));
  };
  var empty = Data_Map.empty;
  var fromFoldable = function (dictFoldable) {
      return function (dictEq) {
          return function (dictOrd) {
              return Data_Foldable.foldl(dictFoldable)(Data_Function.flip(insert(dictOrd)))(empty);
          };
      };
  };
  var mapEntries = function (dictOrd) {
      return function (f) {
          return function (ma) {
              return mapAppend(dictOrd)(f)(ma)(empty);
          };
      };
  };
  var map = function (dictOrd) {
      return function (dictOrd1) {
          return function (f) {
              return mapEntries(dictOrd1)(function (v) {
                  return new Data_Tuple.Tuple(f(v.value0), v.value1);
              });
          };
      };
  };
  var monoidMultiset = function (dictOrd) {
      return new Data_Monoid.Monoid(function () {
          return semigroupMultiset(dictOrd);
      }, empty);
  };
  var groupMultiset = function (dictOrd) {
      return new Data_Group.Group(function () {
          return monoidMultiset(dictOrd);
      }, mapEntries(dictOrd)(function (v) {
  ...
  exports["freq"] = freq;
  exports["set"] = set;
  exports["insertN"] = insertN;
  exports["insert"] = insert;
  exports["fromFoldable"] = fromFoldable;
  exports["semigroupMultiset"] = semigroupMultiset;
  exports["monoidMultiset"] = monoidMultiset;
  exports["groupMultiset"] = groupMultiset;
})(PS["Data.Multiset"] = PS["Data.Multiset"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var writeJSON = function (dictWriteForeign) {
      return function ($42) {
          return Global_Unsafe.unsafeStringify(writeImpl(dictWriteForeign)($42));
      };
  };
  ...
  var recordWriteForeign = function (dictRowToList) {
      return function (dictWriteForeignFields) {
          return new WriteForeign(function (rec) {
              return Data_Foreign.toForeign(writeImplFields(dictWriteForeignFields)(Type_Row.RLProxy.value)(rec));
          });
      };
  };
  ...
  var nilWriteForeignFields = function (dictTypeEquals) {
      return new WriteForeignFields(function (v) {
          return function (v1) {
              return Type_Equality.to(dictTypeEquals)({});
          };
      });
  };
                      ...
                      return function (dictRowCons1) {
                          return new WriteForeignFields(function (v) {
                              return function (rec) {
                                  ...
                                  var result = Data_Record.insert(dictIsSymbol)(dictRowLacks)(dictRowCons1)(Data_Symbol.SProxy.value)(value)(rest);
                                  return result;
                              };
                          });
                      };
...
(function(exports) {
  ...
  var toJson = Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
      return "clues";
      ...
      return "clue";
  }))(Simple_JSON.writeForeignString)(Simple_JSON.nilWriteForeignFields(Type_Equality.refl))()(Type_Row.rowLacks()()()(Type_Row.rowLacking))())()(Type_Row.rowLacks()()()(Type_Row.rowLacking))())))(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
      return "numCols";
  }))(Simple_JSON.writeForeignInt)(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
      return "quote";
  }))(Simple_JSON.writeForeignString)(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
      return "title";
  }))(Simple_JSON.writeForeignString)(Simple_JSON.nilWriteForeignFields(Type_Equality.refl))()(Type_Row.rowLacks()()()(Type_Row.rowLacking))())()(Type_Row.rowLacks()()()(Type_Row.rowLacking))())()(Type_Row.rowLacks()()()(Type_Row.rowLacking))())()(Type_Row.rowLacks()()()(Type_Row.rowLacking))()));
  ...
  var punctuation = re("[\u2026',!@#$%^&*().:;/\\\\\\-]");
  var mkPuzzle = function (dictFoldable) {
      return function (t) {
          return function (q) {
              return function (cols) {
                  return function (c) {
                      return {
                          ...
                          quote: q,
                          numCols: cols,
                          clues: Data_Array.fromFoldable(dictFoldable)(c)
                      };
                  };
              };
          };
  ...
  var lettersRemaining = function (p) {
      return Data_Semigroup.append(Data_Multiset.semigroupMultiset(Data_Ord.ordChar))(countLetters(p.quote))(Data_Group.ginverse(Data_Multiset.groupMultiset(Data_Ord.ordChar))(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Multiset.monoidMultiset(Data_Ord.ordChar))(countLetters)(answers(p))));
  };
  var acronym = function (dictFoldable) {
      return Data_Foldable.foldMap(dictFoldable)(Data_Monoid.monoidString)(function ($118) {
          return Data_String.toUpper(Data_String.take(1)($118));
      });
  };
  var source = function (p) {
      return acronym(Data_Foldable.foldableArray)(answers(p));
  };
...
(function(exports) {
  ...
  var puzzleToGist = function (puzzle) {
      return {
          files: {
              puzzle: {
                  content: Acrostic_Puzzle.toJson(puzzle)
              }
          }
      };
  };
  ...
  var gistResponseFromJson = function (json) {
      return Control_Monad_Except_Trans.withExceptT(Control_Monad_Aff.functorAff)(JsonErr.create)(Control_Monad_Except_Trans.except(Control_Monad_Aff.applicativeAff)(Control_Monad_Except.runExcept(Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "id";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil(Type_Equality.refl))(Type_Row.rowLacks()()()(Type_Row.rowLacking))())(Type_Row.listToRowCons(Type_Row.listToRowNil)()))(json))));
  };
  ...
  var postPuzzleToGist = function (puzzle) {
      var json = Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
          ...
          return "content";
      }))(Simple_JSON.writeForeignString)(Simple_JSON.nilWriteForeignFields(Type_Equality.refl))()(Type_Row.rowLacks()()()(Type_Row.rowLacking))()))(Simple_JSON.nilWriteForeignFields(Type_Equality.refl))()(Type_Row.rowLacks()()()(Type_Row.rowLacking))()))(Simple_JSON.nilWriteForeignFields(Type_Equality.refl))()(Type_Row.rowLacks()()()(Type_Row.rowLacking))()))(puzzleToGist(puzzle));
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Except_Trans.withExceptT(Control_Monad_Aff.functorAff)(AjaxErr.create)(Control_Monad_Except_Trans.ExceptT(Control_Monad_Error_Class["try"](Control_Monad_Aff.monadErrorAff)(Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableString)(Network_HTTP_Affjax_Response.responsableString)(apiBasePath)(json)))))(function (v) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(gistResponseFromJson(v.response))(function (v1) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))(v1.id);
          });
      });
  };
  ...
  exports["postPuzzleToGist"] = postPuzzleToGist;
...
(function(exports) {
  ...
  var setEvent = function (n) {
      return function (v) {
          return DOM_Event_EventTarget.addEventListener(v.value0)(v.value1)(false)(DOM_Node_Types.elementToEventTarget(n));
      };
  };
  var setAttr = function (n) {
      return function (v) {
          return DOM_Node_Element.setAttribute(v.value0)(v.value1)(n);
      };
  };
  var setAttributes = function (n) {
      return Control_Safely.traverse_(Data_CatList.foldableCatList)(Control_Monad_Rec_Class.monadRecEff)(setAttr(n));
  };
  var element = function (name) {
      return function (attrs) {
          return function (events) {
              return function __do() {
                  var v = $foreign.makeElement(name)();
                  setAttributes(v)(attrs)();
                  Control_Safely.traverse_(Data_CatList.foldableCatList)(Control_Monad_Rec_Class.monadRecEff)(setEvent(v))(events)();
                  return v;
              };
          };
      };
  };
  var renderNode = function (p) {
      return function (v) {
          if (v instanceof Text_Smolder_Markup.Element) {
              return function __do() {
                  var v1 = element(v.value0)(v.value2)(v.value3)();
                  render(v1)(v.value1)();
                  var v2 = DOM_Node_Node.appendChild(DOM_Node_Types.elementToNode(v1))(DOM_Node_Types.elementToNode(p))();
                  return v.value4;
              };
          };
          if (v instanceof Text_Smolder_Markup.Content) {
              return function __do() {
                  ...
                  var v2 = DOM_Node_Node.appendChild(DOM_Node_Types.textToNode(v1))(DOM_Node_Types.elementToNode(p))();
                  return v.value1;
              };
          };
          ...
          throw new Error("Failed pattern match at Text.Smolder.Renderer.DOM line 82, column 1 - line 82, column 84: " + [ p.constructor.name, v.constructor.name ]);
      };
  };
  var render = function (target) {
      return Control_Monad_Free.foldFree(Control_Monad_Rec_Class.monadRecEff)(renderNode(target));
  };
...
(function(exports) {
  ...
  var removeAllChildren = function (element) {
      return function __do() {
          var v = DOM_Node_Node.childNodes(element)();
          var v1 = DOM_Node_NodeList.toArray(v)();
          return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(Data_Function.flip(DOM_Node_Node.removeChild)(element))(v1)();
      };
  };
  var getElement = function (name) {
      return function __do() {
          ...
          return DOM_Node_NonElementParentNode.getElementById(name)(DOM_HTML_Types.htmlDocumentToNonElementParentNode(v1))();
      };
  };
  var clobberRender = function (target) {
      return function (markup) {
          return function __do() {
              removeAllChildren(DOM_Node_Types.elementToNode(target))();
              return Text_Smolder_Renderer_DOM.render(target)(markup)();
          };
      };
  };
  exports["clobberRender"] = clobberRender;
...
(function(exports) {
  ...
  var runFlareDom = function (controlsId) {
      return function (targetId) {
          var handler = function (markup) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Flare_Custom.getElement(targetId))(function (v) {
                  return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Eff.monadEff)(Flare_Custom.clobberRender(v)(markup));
              })));
          };
          return Flare.runFlareWith(controlsId)(handler);
      };
  };
  ...
  var renderLetterCount = function (cs) {
      var renderChar = function (v) {
          var td$prime = (function () {
              var $11 = v.value1 >= 0;
              if ($11) {
                  return Text_Smolder_HTML.td;
              };
              return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.td)(Text_Smolder_HTML_Attributes.className("err"));
          })();
          return Text_Smolder_HTML.tr(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(td$prime(Text_Smolder_Markup.text(Data_String.singleton(v.value0) + ":")))(function () {
              return td$prime(Text_Smolder_Markup.text(Data_Show.show(Data_Show.showInt)(v.value1)));
          }));
      };
      return Text_Smolder_HTML.table(Data_Foldable.traverse_(Control_Monad_Free.freeApplicative)(Data_List_Lazy_Types.foldableList)(renderChar)(Data_Multiset.entryList(cs)));
  };
  ...
  var renderBoard = function (quote) {
      return function (numCols) {
          var renderRow = function (row) {
              return Text_Smolder_HTML.tr(Data_Foldable.traverse_(Control_Monad_Free.freeApplicative)(Data_Foldable.foldableArray)(renderCell(Acrostic_Puzzle.showBoardIdx))(row));
          };
          var formattedQuote = reshape(numCols)(indexChars(quote));
  ...
  var renderPuzzle = function (p) {
      var save = function (e) {
          return Control_Monad_Aff.launchAff_(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Acrostic_Gist.postPuzzleToGist(p))(function (v) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Aff.monadEffAff))(Try_QueryString.setQueryStrings(Data_StrMap.singleton("gist")(v)));
          })));
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.div(Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.button)(Text_Smolder_HTML_Attributes.id("save-button")))(Text_Smolder_Markup.on("click")(DOM_Event_EventTarget.eventListener(save)))(Text_Smolder_Markup.text("Save"))))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.div(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkup)(renderBoard(p.quote)(p.numCols))(Text_Smolder_HTML_Attributes.id("board"))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.div(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.label)(Text_Smolder_HTML_Attributes["for"]("author"))(Text_Smolder_Markup.text("Source:")))(function () {
                  return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.span)(Text_Smolder_HTML_Attributes.id("author"))(Text_Smolder_Markup.text(Acrostic_Puzzle.source(p)));
              })))(function () {
                  return Text_Smolder_HTML.div(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.label)(Text_Smolder_HTML_Attributes["for"]("chars-left"))(Text_Smolder_Markup.text("Letters remaining:")))(function () {
                      return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkup)(renderLetterCount(Acrostic_Puzzle.lettersRemaining(p)))(Text_Smolder_HTML_Attributes.id("chars-left"));
                  }));
              });
          });
      });
  };
  var clueUi = function (clue) {
      return Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Acrostic_Puzzle.mkClue)(Flare.string("Clue:")(clue.clue)))(Flare.string("Answer:")(clue.answer));
  };
  var cluesUi = function (clues) {
      var emptyClue = Acrostic_Puzzle.mkClue("")("");
      return Flare.resizableList("Clues:")(clueUi)(emptyClue)(clues);
  };
  var puzzleUi = function (p) {
      return Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(Acrostic_Puzzle.mkPuzzle(Data_List_Types.foldableList))(Flare.string("Title:")(p.title)))(Flare.textarea("Quote:")(p.quote)))(Flare.intSlider("Columns:")(1)(20)(p.numCols)))(cluesUi(Data_List.fromFoldable(Data_Foldable.foldableArray)(p.clues)));
  };
  var main = Control_Monad_Aff.launchAff_(Control_Bind.bind(Control_Monad_Aff.bindAff)(Acrostic_Gist.loadPuzzleFromQueryString)(function (v) {
      var htmlUi = Data_Functor.map(Flare.functorUI)(renderPuzzle)(puzzleUi(v));
      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(runFlareDom("controls")("board")(htmlUi));
  }));
